...
import com.reader.dao.TopNMapper;
import com.reader.entity.TopNResult;
import com.reader.entity.Vote;
import com.reader.task.SchedulingTest;
...
public class TopNServiceImpl extends ServiceImpl<TopNMapper, Vote> implements TopNService {
    ...
    public List<Map<String, Object>> getDailyIncrRankingBoard() throws Exception{
        ...
        List<Map<String, Object>> yestodayResult = topNMapper.getDailyIncrRankingBoard(YESTERDAY);
        List<Map<String, Object>> dayBeforeYesterdayResult = topNMapper.getDailyIncrRankingBoard(DAY_BEFORE_YESTERDAY);
        ...
        yestodayResult = yestodayResult.subList(0, 20 > yestodayResult.size() ? yestodayResult.size() : 20 );
    ...
    public List<Collection<Object>> getScrollBoard() {
        //查询今天最新201个博主投票数据
        List<Map<String, Object>> todayResult = topNMapper.getScrollBoard(TODAY);
        //查询昨天最后一次采集201个博主投票数据
        List<Map<String, Object>> yesTodayResult = topNMapper.getScrollBoard(YESTERDAY);
        //构造最终返回的集合
    ...
    public Map<String, Object> DigitalFlop() throws Exception{
        return schedulingTest.doGetTopNUrl();
    }

    @Override
    public Object doPostTopNIncrement() throws Exception {
        //获取72小时增量投票数据
        Object o = schedulingTest.doPostTopNIncrement();
        //使用fastjson转换为CsdnTopNResult对象

        TopNResult result = JSONObject.parseObject((String) o, TopNResult.class);
        //获取结果对象中的433个采集时间点
    ...
    @Override
    public Object doPostTop20() throws Exception {
        //爬取投票数据
        Object o = schedulingTest.doPostTop20();
        //封装到结果集对象中
        TopNResult result = JSONObject.parseObject((String) o, TopNResult.class);
        ...
        for (int i = 0; i < ticket.size(); i++) {
            TopNResult.Ticket t = ticket.get(i);
            //获取博主的投票数集合
            List<Integer> data = t.getData();
